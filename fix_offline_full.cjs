...
if (content.includes(target)) {
  ...
  console.log('Successfully replaced seed method in offlineCache.service.ts');
} else {
  console.log('Target not found in offlineCache.service.ts');
}
