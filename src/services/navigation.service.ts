...
export const NAV_ITEMS_REGISTRY: NavItemDef[] = [
  ...
  // 4. PRODUCTION SYSTEM TOOLS (CONSOLIDATED REBUILD - EXACTLY 3 TOOLS)
  {
    ...
    icon: 'ShieldCheck',
    allowedRoles: ['SUPER_ADMIN', 'PROJECT_ADMIN'],
    descriptionAr: 'إدارة وتفويض المستخدمين، الاستثناءات التشغيلية والمالية، وسجلات التدقيق المتقدمة',
    isPrimary: false,
    isHighRisk: true,
  },
  {
    ...
    titleAr: 'الأمن والامتثال الحوكمي (Security & Compliance)',
    titleEn: 'Security & Compliance',
    badgeAr: 'مؤشرات الأمان',
    badgeEn: 'Governance Status',
    badgeVariant: 'blue',
    icon: 'ShieldCheck',
