...
**Generated At:** 2026-09-19T05:53:04.479Z
**Total Catalog Entries Processed:** 13797
**Total Proposals Requiring Human Review:** 13791 (100.0%)
...
| :--- | :--- | :--- |
| `SEMANTIC_CONFLICT` | **1624** | Identical source texts with different operational meanings quarantined to prevent UI/business conflation |
...
| `PLURALIZATION_RISK` | **129** | Quantities requiring 6 Arabic plural forms aligned with target language plural rules |
| `REPORT_EXPORT_RISK` | **3522** | Report column or export header requiring separation of internal data key from display label |
| `BUSINESS_DATA_RISK` | **802** | Formulas, rates, or business calculations requiring strict identifier preservation |
| `LOW_CONFIDENCE` | **7705** | Ambiguous or composite phrases generated with low statistical confidence |
...
### 1. Reason: `SEMANTIC_CONFLICT` (1624 items)
...
| ... | *and 1599 more items in this queue* | | | |
...
### 1. Reason: `PLURALIZATION_RISK` (129 items)
...
| ... | *and 104 more items in this queue* | | | |

### 1. Reason: `REPORT_EXPORT_RISK` (3522 items)
...
| ... | *and 3497 more items in this queue* | | | |

### 1. Reason: `BUSINESS_DATA_RISK` (802 items)
...
| ... | *and 777 more items in this queue* | | | |

### 1. Reason: `LOW_CONFIDENCE` (7705 items)
...
| ... | *and 7680 more items in this queue* | | | |
