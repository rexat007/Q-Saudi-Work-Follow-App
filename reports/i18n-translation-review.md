...
| `navigation.labels.project_4` | "إجمالي الكميات الموردة بالمشروع" | "إجمالي الكميات الموردة بProject" | "إجمالي الكميات الموردة بپروجیکٹ" | Validate plural rules for Arabic (zero, one, two, few, many, other) vs English/Urdu (one, other). |
