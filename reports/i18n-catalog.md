...
**Generated At:** 2026-09-13T12:06:29.573Z
...
| :--- | :--- | :--- |
| **Total Files Scanned** | 251 | TypeScript and TSX files analyzed in `src/` |
| **Total Extracted Candidates** | 32499 | Total strings and text nodes parsed |
| **Real User-Facing Texts** | 8742 | Confirmed visible Arabic and UI texts |
| **Likely User-Facing Texts** | 353 | English UI text in visible elements |
| **Ambiguous Texts** | 7611 | Short or context-isolated tokens for manual review |
| **Technical Strings** | 6868 | CSS classes, paths, enums, regexes, operators |
| **Non-User-Facing Strings** | 8925 | Internal IDs, collection names, database keys |
| **Distinct Proposed Keys** | 7738 | Hierarchical keys generated (e.g. `shared.actions.save`) |
| **Duplicate Groups** | 3885 | Sets of identical/normalized recurring texts |
| **Semantic Conflict Groups** | 511 | Identical texts requiring distinct contextual keys |
| **Keys Requiring Review** | 9497 | Entries flagged with special cases or ambiguity |
...
| :--- | :--- | :--- |
| `other` | 4110 | Classified operational domain |
