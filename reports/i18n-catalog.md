...
**Generated At:** 2026-09-14T03:49:12.850Z
...
| :--- | :--- | :--- |
| **Total Files Scanned** | 263 | TypeScript and TSX files analyzed in `src/` |
| **Total Extracted Candidates** | 33689 | Total strings and text nodes parsed |
| **Real User-Facing Texts** | 8810 | Confirmed visible Arabic and UI texts |
| **Likely User-Facing Texts** | 351 | English UI text in visible elements |
| **Ambiguous Texts** | 8008 | Short or context-isolated tokens for manual review |
| **Technical Strings** | 6880 | CSS classes, paths, enums, regexes, operators |
| **Non-User-Facing Strings** | 9640 | Internal IDs, collection names, database keys |
| **Distinct Proposed Keys** | 7797 | Hierarchical keys generated (e.g. `shared.actions.save`) |
| **Duplicate Groups** | 4030 | Sets of identical/normalized recurring texts |
| **Semantic Conflict Groups** | 558 | Identical texts requiring distinct contextual keys |
| **Keys Requiring Review** | 9911 | Entries flagged with special cases or ambiguity |
| **High / Critical Risk Hotspots** | 2214 | Concatenations, templates, or business data overlaps |

## 2. Category Distribution

| Semantic Category | User-Facing Strings | Description |
| :--- | :--- | :--- |
| `other` | 4178 | Classified operational domain |
...
- **Total Directional Usages Detected:** 322
- **Must Migrate (Physical to Logical):** 227 (e.g. `text-left` -> `text-start`, `pl-` -> `ps-`)
...
- **Mixed Numbers & Units:** 870
- **Currency String Usages:** 400
- **Unit String Usages:** 790
