...
**Generated At:** 2026-09-20T11:00:08.513Z
...
| **Total Extracted Candidates** | 45332 | Total strings and text nodes parsed |
| **Real User-Facing Texts** | 10658 | Confirmed visible Arabic and UI texts |
| **Likely User-Facing Texts** | 409 | English UI text in visible elements |
| **Ambiguous Texts** | 12847 | Short or context-isolated tokens for manual review |
...
| **Distinct Proposed Keys** | 9299 | Hierarchical keys generated (e.g. `shared.actions.save`) |
...
| **Keys Requiring Review** | 15115 | Entries flagged with special cases or ambiguity |
...
| :--- | :--- | :--- |
| `other` | 4542 | Classified operational domain |
