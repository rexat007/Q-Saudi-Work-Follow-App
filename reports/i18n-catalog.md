...
**Generated At:** 2026-09-13T13:04:39.307Z
...
| :--- | :--- | :--- |
| **Total Files Scanned** | 253 | TypeScript and TSX files analyzed in `src/` |
| **Total Extracted Candidates** | 32616 | Total strings and text nodes parsed |
| **Real User-Facing Texts** | 8756 | Confirmed visible Arabic and UI texts |
| **Likely User-Facing Texts** | 353 | English UI text in visible elements |
| **Ambiguous Texts** | 7654 | Short or context-isolated tokens for manual review |
| **Technical Strings** | 6868 | CSS classes, paths, enums, regexes, operators |
| **Non-User-Facing Strings** | 8985 | Internal IDs, collection names, database keys |
| **Distinct Proposed Keys** | 7755 | Hierarchical keys generated (e.g. `shared.actions.save`) |
| **Duplicate Groups** | 3903 | Sets of identical/normalized recurring texts |
| **Semantic Conflict Groups** | 525 | Identical texts requiring distinct contextual keys |
| **Keys Requiring Review** | 9543 | Entries flagged with special cases or ambiguity |
| **High / Critical Risk Hotspots** | 2200 | Concatenations, templates, or business data overlaps |

## 2. Category Distribution

| Semantic Category | User-Facing Strings | Description |
| :--- | :--- | :--- |
| `other` | 4124 | Classified operational domain |
...
- **Interpolation Placeholders (`{...}`):** 235
- **Mixed Numbers & Units:** 865
- **Currency String Usages:** 390
- **Unit String Usages:** 762
- **Protected Business Field Matches:** 340
