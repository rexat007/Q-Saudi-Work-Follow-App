...
**Generated At:** 2026-09-13T12:06:35.616Z
...
| :--- | :--- | :--- | :--- |
| **Total Entries Processed** | **10951** | 100.0% | Complete catalog coverage |
| **Generated English Proposals** | **10951** | 100.0% | English target translation proposals |
| **Generated Urdu Proposals** | **10951** | 100.0% | Urdu target translation proposals |
| **Review-Required Proposals** | **10945** | 99.9% | Flagged for human translator sign-off |
| **High-Risk Entries** | **10945** | 99.9% | Formulas, conflicts, or complex templates |
| **Interpolation Entries** | **209** | 1.9% | Dynamic parameters strictly preserved |
...
| **Semantic Conflicts Isolated** | **1279** | 11.7% | Distinct contextual keys maintained |
...
| **MEDIUM** | **3226** | 29.5% | Contextual UI terms with clear semantics |
| **LOW** | **7586** | 69.3% | Ambiguous phrases, high risk, or conflicts (Review Mandatory) |
...
| **Tier 4: High Risk** | **10945** | Semantic conflicts, complex templates, mixed calculations |

## 4. Category Breakdown

| Category | Total Entries | Generated | Review Required | High Conf | Med Conf | Low Conf |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `other` | 4670 | 4670 | 4666 | 82 | 1104 | 3484 |
...
| :--- | :--- | :--- |
| `SEMANTIC_CONFLICT` | **1279** | Triggered by rule engine classification |
...
| `REPORT_EXPORT_RISK` | **3755** | Triggered by rule engine classification |
| `BUSINESS_DATA_RISK` | **1555** | Triggered by rule engine classification |
| `LOW_CONFIDENCE` | **10945** | Triggered by rule engine classification |
