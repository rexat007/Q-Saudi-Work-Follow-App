...
**Generated At:** 2026-09-13T10:58:49.015Z
...
| :--- | :--- | :--- | :--- |
| **Total Entries Processed** | **10883** | 100.0% | Complete catalog coverage |
| **Generated English Proposals** | **10883** | 100.0% | English target translation proposals |
| **Generated Urdu Proposals** | **10883** | 100.0% | Urdu target translation proposals |
| **Review-Required Proposals** | **10877** | 99.9% | Flagged for human translator sign-off |
| **High-Risk Entries** | **10877** | 99.9% | Formulas, conflicts, or complex templates |
| **Interpolation Entries** | **210** | 1.9% | Dynamic parameters strictly preserved |
...
| **Semantic Conflicts Isolated** | **1260** | 11.6% | Distinct contextual keys maintained |
...
| **MEDIUM** | **3218** | 29.6% | Contextual UI terms with clear semantics |
| **LOW** | **7526** | 69.2% | Ambiguous phrases, high risk, or conflicts (Review Mandatory) |
...
| **Tier 4: High Risk** | **10877** | Semantic conflicts, complex templates, mixed calculations |

## 4. Category Breakdown

| Category | Total Entries | Generated | Review Required | High Conf | Med Conf | Low Conf |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `other` | 4602 | 4602 | 4598 | 82 | 1096 | 3424 |
...
| :--- | :--- | :--- |
| `SEMANTIC_CONFLICT` | **1260** | Triggered by rule engine classification |
...
| `REPORT_EXPORT_RISK` | **3719** | Triggered by rule engine classification |
| `BUSINESS_DATA_RISK` | **1550** | Triggered by rule engine classification |
| `LOW_CONFIDENCE` | **10877** | Triggered by rule engine classification |
