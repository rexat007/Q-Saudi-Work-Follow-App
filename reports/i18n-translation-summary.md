...
**Generated At:** 2026-09-20T07:02:22.656Z
...
| :--- | :--- | :--- | :--- |
| **Total Entries Processed** | **14198** | 100.0% | Complete catalog coverage |
| **Generated English Proposals** | **14198** | 100.0% | English target translation proposals |
| **Generated Urdu Proposals** | **14198** | 100.0% | Urdu target translation proposals |
| **Review-Required Proposals** | **14192** | 100.0% | Flagged for human translator sign-off |
| **High-Risk Entries** | **14192** | 100.0% | Formulas, conflicts, or complex templates |
| **Interpolation Entries** | **236** | 1.7% | Dynamic parameters strictly preserved |
...
| **Semantic Conflicts Isolated** | **1665** | 11.7% | Distinct contextual keys maintained |
...
| **MEDIUM** | **3871** | 27.3% | Contextual UI terms with clear semantics |
| **LOW** | **10180** | 71.7% | Ambiguous phrases, high risk, or conflicts (Review Mandatory) |
...
| **Tier 4: High Risk** | **14192** | Semantic conflicts, complex templates, mixed calculations |
...
| `navigation` | 535 | 535 | 535 | 2 | 120 | 413 |
...
| :--- | :--- | :--- |
| `SEMANTIC_CONFLICT` | **1665** | Triggered by rule engine classification |
...
| `REPORT_EXPORT_RISK` | **4140** | Triggered by rule engine classification |
| `BUSINESS_DATA_RISK` | **1783** | Triggered by rule engine classification |
| `LOW_CONFIDENCE` | **14192** | Triggered by rule engine classification |
