...
**Generated At:** 2026-09-13T09:40:26.442Z
...
| :--- | :--- | :--- | :--- |
| **Total Entries Processed** | **10778** | 100.0% | Complete catalog coverage |
| **Generated English Proposals** | **10778** | 100.0% | English target translation proposals |
| **Generated Urdu Proposals** | **10778** | 100.0% | Urdu target translation proposals |
| **Review-Required Proposals** | **10772** | 99.9% | Flagged for human translator sign-off |
| **High-Risk Entries** | **10772** | 99.9% | Formulas, conflicts, or complex templates |
...
| **Semantic Conflicts Isolated** | **1223** | 11.3% | Distinct contextual keys maintained |
...
| **MEDIUM** | **3206** | 29.7% | Contextual UI terms with clear semantics |
| **LOW** | **7433** | 69.0% | Ambiguous phrases, high risk, or conflicts (Review Mandatory) |
...
| **Tier 4: High Risk** | **10772** | Semantic conflicts, complex templates, mixed calculations |

## 4. Category Breakdown

| Category | Total Entries | Generated | Review Required | High Conf | Med Conf | Low Conf |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `other` | 4497 | 4497 | 4493 | 82 | 1084 | 3331 |
...
| :--- | :--- | :--- |
| `SEMANTIC_CONFLICT` | **1223** | Triggered by rule engine classification |
...
| `REPORT_EXPORT_RISK` | **3658** | Triggered by rule engine classification |
| `BUSINESS_DATA_RISK` | **1539** | Triggered by rule engine classification |
| `LOW_CONFIDENCE` | **10772** | Triggered by rule engine classification |
