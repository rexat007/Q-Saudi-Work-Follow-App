...
**Generated At:** 2026-09-13T10:58:53.890Z
...
| :--- | :--- | :--- |
| **Total Unique Catalog Keys** | **10883** | Distinct semantic translation keys generated |
| **Translated Keys (Phase 1 Foundation)** | **6** | Approved canonical terms (ar, en, ur verified) |
| **Untranslated Slots (Pending Review)** | **7685** | Explicitly flagged for professional human review |
| **Review Required Keys** | **7685** | Domain terminology requiring semantic verification |
| **Ambiguous Keys Isolated** | **3191** | Short tokens or codes quarantined from auto-translation |
| **Protected Business Tokens** | **1** | Database identifiers, formulas, units, currencies |
| **Interpolation Placeholders** | **210** | Dynamic parameters (e.g. `{count}`) strictly preserved |
| **Pluralization Requirements** | **150** | Expressions requiring 6 Arabic plural forms |
| **Semantic Conflicts Isolated** | **502** | Identical texts split into separate contextual keys |
| **Duplicate Groups (Type A Sharing)** | **1616** | Safe identical-context key reuse candidates |
