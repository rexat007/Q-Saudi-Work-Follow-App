...
**Generated At:** 2026-09-12T11:48:33.785Z
...
| :--- | :--- | :--- |
| **Total Unique Catalog Keys** | **8688** | Distinct semantic translation keys generated |
| **Translated Keys (Phase 1 Foundation)** | **5** | Approved canonical terms (ar, en, ur verified) |
| **Untranslated Slots (Pending Review)** | **5692** | Explicitly flagged for professional human review |
| **Review Required Keys** | **5692** | Domain terminology requiring semantic verification |
| **Ambiguous Keys Isolated** | **2990** | Short tokens or codes quarantined from auto-translation |
...
| **Pluralization Requirements** | **125** | Expressions requiring 6 Arabic plural forms |
| **Semantic Conflicts Isolated** | **305** | Identical texts split into separate contextual keys |
| **Duplicate Groups (Type A Sharing)** | **1412** | Safe identical-context key reuse candidates |
