...
**Generated At:** 2026-09-13T03:28:49.609Z
...
| :--- | :--- | :--- |
| **Total Unique Catalog Keys** | **8503** | Distinct semantic translation keys generated |
| **Translated Keys (Phase 1 Foundation)** | **6** | Approved canonical terms (ar, en, ur verified) |
| **Untranslated Slots (Pending Review)** | **5456** | Explicitly flagged for professional human review |
| **Review Required Keys** | **5456** | Domain terminology requiring semantic verification |
| **Ambiguous Keys Isolated** | **3040** | Short tokens or codes quarantined from auto-translation |
...
| **Duplicate Groups (Type A Sharing)** | **1419** | Safe identical-context key reuse candidates |
